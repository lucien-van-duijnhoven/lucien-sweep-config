...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //---------------------------------------------------------------------------------------       ----------------------------------------------------------------------------------
   ...
   [1] = LAYOUT(
  //---------------------------------------------------------------------------------------       ----------------------------------------------------------------------------------
    KC_ESCAPE, KC_AT    ,LSFT(KC_3)     ,TD(DANCE_31)     ,KC_PERC ,                            KC_BSPC , MT(KC_COLN,KC_SCOLON)   ,    KC_ASTR   ,   KC_AMPR   ,    KC_CIRC   ,
  //----------------------------------------------------------------------------       ----------------------------------------------------------------------------------
    KC_TAB,   KC_LCBR    ,KC_LBRC    ,KC_LPRN    ,KC_LEFT_ANGLE_BRACKET ,               KC_ENTER  ,    KC_RCBR,     KC_RBRC,  KC_RPRN,       KC_RIGHT_ANGLE_BRACKET,
  //----------------------------------------------------------------------------       ----------------------------------------------------------------------------------
    MT(KC_TILDE,KC_GRAVE), MT(KC_QUOTE, KC_DOUBLE_QUOTE)  ,KC_PIPE   ,KC_COLON   ,KC_BACKSLASH   ,                  TO(2)   ,    KC_EXCLAIM   ,     KC_QUESTION   ,  KC_SEMICOLON   ,   KC_SLASH    ,
  //---------------------------------------------------------------------------------------       ----------------------------------------------------------------------------------
		    					                                                        TO(0) ,OSM(MOD_LSFT),                                                                     TO(3),              KC_RALT
  ),
